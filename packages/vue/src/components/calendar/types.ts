...
export interface RootProps {
   ...
   */
  defaultValue?: calendar.DateValue[]
  /**
   * The initial view of the calendar when it is first rendered.
   */
  defaultView?: calendar.DateView
  /**
   ...
   * The focused date.
   */
  focusedValue?: calendar.DateValue
  /**
  ...
  ids?: Partial<{
    ...
    prevTrigger: (view: calendar.DateView) => string
    nextTrigger: (view: calendar.DateView) => string
    viewTrigger: (view: calendar.DateView) => string
    clearTrigger: string
    control: string
   ...
   * @default "year"
   */
  maxView?: calendar.DateView
  /**
   * The minimum date that can be selected.
   */
  min?: calendar.DateValue
  /**
   * The minimum view of the calendar
   * @default "day"
   */
  minView?: calendar.DateView
  /**
   * The v-model value of the calendar
   */
  modelValue?: calendar.DateValue[]
  /**
   ...
   */
  positioning?: calendar.PositioningOptions
  /**
   ...
   */
  translations?: calendar.IntlTranslations
  /**
   * The view of the calendar
   * @default "day"
   */
  view?: calendar.DateView
}
...
export interface RootEmits {
   ...
   */
  'focusChange': [details: calendar.FocusChangeDetails]
  /**
   * Function called when the calendar opens or closes.
   */
  'openChange': [details: calendar.OpenChangeDetails]
  /**
   * Function called when the value changes.
   */
  'valueChange': [details: calendar.ValueChangeDetails]
  /**
   * Function called when the view changes.
   */
  'viewChange': [details: calendar.ViewChangeDetails]
  /**
   * The callback fired when the model value changes.
   */
  'update:modelValue': [value: calendar.DateValue[]]
  /**
   ...
   */
  'update:view': [view: calendar.DateView]
}
