import type * as tree from '@destyler/tree'
...
export interface RootEmits {
   ...
   */
  'expandedChange': [details: tree.ExpandedChangeDetails]
  /**
   * Called when the focused node changes
   */
  'focusChange': [details: tree.FocusChangeDetails]
  /**
   * Called when the selection changes
   */
  'selectionChange': [details: tree.SelectionChangeDetails]
