...
function ComponentUnderTest(props: ComponentUnderTestProps) {
  const [radioProps, localProps] = splitProps(props, ['onValueChange'])
  return (
    <Menu.Root {...localProps}>
      ...
      <Menu.Positioner data-testid="positioner">
        <Menu.Content>
          ...
          <Menu.Separator />
          <Menu.RadioItemGroup value="react" {...radioProps}>
