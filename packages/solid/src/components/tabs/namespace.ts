...
export { TabsContext as Context, type TabsContextProps as ContextProps } from './components/Context'
export {
...
export type { FocusChangeDetails, ValueChangeDetails } from '@destyler/tabs'
