<script module lang="ts">
  ...
  export interface InitialValueProps extends Omit<SelectRootProps<Framework>, 'collection'> {}
</script>

<script lang="ts">
  import { Select, createListCollection } from '../index'

  const props: InitialValueProps = $props()
...
<Select.Root defaultValue={["vue"]} {collection} {...props}>
