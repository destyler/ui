...
export interface UseCalendarTableCellPropsContext extends Accessor<CellProps> {}
...
export const [CalendarTableCellPropsProvider, useCalendarTableCellPropsContext]
  = createContext<UseCalendarTableCellPropsContext>({
    name: 'CalendarTableCellPropsContext',
    hookName: 'useCalendarTableCellPropsContext',
    providerName: '<CalendarTableCellPropsProvider />',
  })
