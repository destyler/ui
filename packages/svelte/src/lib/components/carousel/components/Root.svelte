<script module lang="ts">
  ...
  import type { UseCarouselProps } from '../hooks/use-carousel.svelte'

  export interface CarouselRootBaseProps extends Optional<UseCarouselProps, 'id'>, PolymorphicProps<'div'> {}
...
<script lang="ts">
  ...
  import { useCarousel } from '../hooks/use-carousel.svelte'
