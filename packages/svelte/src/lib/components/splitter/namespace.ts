export { default as Context, type SplitterContextProps as ContextProps } from './components/Context.svelte'
export {
  default as Panel,
  type SplitterPanelBaseProps as PanelBaseProps,
  type SplitterPanelProps as PanelProps,
} from './components/Panel.svelte'
export {
...
export type { PanelSizeData, SizeChangeDetails } from '@destyler/splitter'
