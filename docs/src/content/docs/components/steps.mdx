...
Control the active step programmatically.

<ComponentPreview component="steps" example="Controlled" />

### Initial Step

Seed the starting step with `defaultStep`.

<ComponentPreview component="steps" example="InitialStep" />
